    ...
    <section id="feedback-about">
      <div className="container py-5">
        ...
        <Paragraph
          ...
          align={"center"}
          text={
            "We have been always very open to our critics, and have always lent our ears to the feedbacks. Let’s look at some of them."
          }
        />
        ...
        <div className="row p-1 justify-content-center">
          ...
          <div className="col-sm">
            <FeedbackCard
              color={"#075aae"}
              personLine={"I want to go to zoo"}
              person={"Giraffe"}
              text={
                "” Aenean sollicitudin, lorem quis auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit.“"
              }
